...
const VirtualBooking = ({ doctorId, ticketPrice, timeSlots }) => {
  const [loading, setLoading] = useState(false);
  const [userDetails, setUserDetails] = useState({ name: '', email: '', startTime: '', endTime: '', appointmentDate: '',appointmentType:'virtual' });
