...
function Home() {
  return (
    <>
      <section className="hero__section pt-[60px] zxl:h-[800px]">
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem totam distinctio consectetur!
                  Blanditiis cupiditate assumenda facere ut dolor provident, qui ad minima facilis. Eos dolorem esse
            ...
            <div className="flex gap-[30px]">
              ...
              <div className="mt-[30px]">
                <img src={heroImg02} className="w-full mb-[30px]" alt="Hero 2" />
                <img src={heroImg03} className="w-full" alt="Hero 3" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="container">
          <div className="lg:w-[470px] mx-auto text-center">
            <h2 className="heading">Providing best medical services</h2>
            <p className="text__para">
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pt-4">
                ...
                <li className="text__para">3. View our physicians who are new patients, use the online scheduling tool to select an appointment time.</li>
              </ul>
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[6px] lg:gap-3">
                    <p className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600p]">
                      Tue, 24
                    </p>
                ...
                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lf:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full">
                  Consultation
                </div>
